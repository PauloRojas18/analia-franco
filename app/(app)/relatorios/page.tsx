...
import { Download, Printer, FileText, Users, GraduationCap, Calendar, Loader2, Briefcase, BookOpen, Search, ChevronDown, Check } from "lucide-react"
  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; margin: 0; padding: 0; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
      ...
      h1.titulo { text-align: center; font-size: 16px; color: #444; margin-bottom: 24px; font-weight: 400; letter-spacing: 0.5px; }
