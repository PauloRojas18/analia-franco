...
export default function AlunosPage() {
  ...
  const buscarVinculos = useCallback(async (codigoBarras: string) => {
    try {
      const res = await fetch(
        `/api/vinculos/lista?codigoBarras=${codigoBarras}`,
      );
  ...
  async function removerVinculo(vinculo: Vinculo) {
    if (!editando) {
      setVinculos((prev) =>
        prev.filter((v) => v.codigoBarras !== vinculo.codigoBarras),
      );
      return;
    }
    try {
  ...
  const campos = [
    ...
    },
    {
      key: "blocoEstudo",
      label: "Curso",
      placeholder: "Ex: Vibração, Noções básicas",
      ...
      {modalAberto && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div
            ...
            style={{
              background:
                "color-mix(in srgb, var(--sidebar-bg) 75%, transparent)",
            }}
            onClick={fecharModal}
          />
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 24px 48px rgba(0,0,0,0.35), 0 1px 0 rgba(255,255,255,0.06) inset",
            }}
          >
              ...
              <div className="mt-5 flex flex-col gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onFocus={() =>
                      resultadosBusca.length > 0 && setMostrarDropdown(true)
                    }
                ...
                <p
                  ...
                  style={{ color: "var(--muted-foreground)" }}
                >
                  Alunos podem ser vinculados a pacientes e trabalhadores (não
                  instrutores).
                </p>
              </div>
