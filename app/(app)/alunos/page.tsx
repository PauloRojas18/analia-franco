    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Gerencie o cadastro de alunos da casa espírita</p>
        </div>
        <Button onClick={abrirNovo}><Plus className="mr-2 h-4 w-4" />Novo Aluno</Button>
      </div>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-end gap-1">
                          <Button variant="ghost" size="icon" onClick={() => abrirEditar(a)}><Pencil className="h-4 w-4" /></Button>
                          <Button variant="ghost" size="icon" onClick={() => toggleAtivo(a)}>
            ...
            <div className="p-8 overflow-y-auto modal-scroll flex-1">
              ...
              {!editando && (
                <p className="mt-3 text-xs" style={{ color: "var(--muted-foreground)" }}>
                  Código gerado automaticamente com prefixo <span className="font-mono font-semibold">CEFASA</span>.
                </p>
              )}
